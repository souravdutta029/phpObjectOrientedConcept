...
if(isset($_POST['update'])){
    ...
    if($title == '' || $catid == '' || $author == '' || $tags == '' || $content == ''){
        ...
        $update_q = "UPDATE posts SET category_id = '$catid', title = '$title', content = '$content', 
        author =  '$author', tags = '$tags' WHERE id = '$post_id'";
...
<br>
    ...
    <select class="form-control" name="catid" >
      ...
      <?php
        while($cat_name = $cats->fetch_assoc()){
      ?>
      <option value="<?php echo $cat_name['id']; ?>"><?php echo $cat_name['title']; ?></option>
        <?php }?>
    </select>
    
    <div class="form-group">
        <label>Author Name:</label>
        <input type="text" class="form-control" name="author"  value="<?php echo $single['author']; ?>">
    </div>

    <div class="form-group">
        <label>Post Content:</label>
        <textarea name="content" class="form-control" rows="3" ><?php echo $single['content']; ?></textarea>
    </div>
    
    <div class="form-group">
        <label>Tags:</label>
        <input type="text" class="form-control" name="tags" value="<?php echo $single['tags']; ?>">
    </div>
  
    <button type="submit" name="update" class="btn btn-success">Update</button>
    <a href="index.php" class="btn btn-info">Cancel</a>
    <a href="delete_post.php?delete_id=<?php echo $post_id; ?>" class="btn btn-danger">Delete Post</a>
</form>
